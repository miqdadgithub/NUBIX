  ...
  return (
    <div className="min-h-screen gradient-primary flex items-center justify-center">
      <div className="text-center">
        {/* NUBIX Logo */}
        <div className="mb-8">
          <div className="w-32 h-32 mx-auto bg-white bg-opacity-20 rounded-3xl flex items-center justify-center mb-6 animate-pulse">
          ...
          <p className="text-white text-opacity-80 text-lg">Your Gateway to Cryptocurrency</p>
        </div>
